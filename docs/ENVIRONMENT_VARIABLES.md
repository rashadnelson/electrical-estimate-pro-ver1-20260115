...
This document describes all the environment variables required for Electrical Estimate Pro.
...
- `BETTER_AUTH_URL` - Base URL for Better-Auth (optional in development)
  - Example: `https://electricalestimatepro.dev`
...
- `RESEND_FROM_EMAIL` - Email address to send from
  - Example: `noreply@electricalestimatepro.dev`
