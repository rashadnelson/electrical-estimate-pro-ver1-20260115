...
{
  "type": "action",
  "description": "Fill estimate form: title 'Panel Upgrade 200A', client name 'John Doe', client phone '555-1234', client address '123 Main St'. Add line items: Labor item 'Electrical Panel Install' quantity 2, unit price 150, type 'labor'; Material item 'Copper Wire 10 AWG' quantity 10, unit price 5, type 'material'"
}
```
...
{
  "type": "action",
  "description": "Wait for dialog with role='dialog' to be visible. Wait for element with data-testid='estimate-title-input' to be enabled. Fill estimate-title-input with 'Panel Upgrade 200A'. Fill estimate-client-name-input with 'John Doe'. Fill estimate-client-phone-input with '555-1234'. Fill estimate-client-address-input with '123 Main St'. Wait for line-item-0-description to be visible. Fill line-item-0-description with 'Electrical Panel Install'. Click line-item-0-type-select, wait for role='listbox' to appear, click option 'Labor'. Clear and fill line-item-0-quantity with '2'. Clear and fill line-item-0-unit-price with '150'. Click add-line-item-button. Wait for line-item-1-description to be visible. Fill line-item-1-description with 'Copper Wire 10 AWG'. Click line-item-1-type-select, wait for role='listbox' to appear, click option 'Material'. Clear and fill line-item-1-quantity with '10'. Clear and fill line-item-1-unit-price with '5'. Wait for estimate-total to contain text '350.00'."
}
```
