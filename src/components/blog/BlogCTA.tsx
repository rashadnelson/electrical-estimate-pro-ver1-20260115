  ...
  return (
    <div className="p-8 gradient-hero rounded-lg mt-12 mb-8 text-primary-foreground">
      <h2 className="text-2xl md:text-3xl font-bold mb-4">
        Ready to create professional electrical estimates?
      </h2>
      <p className="text-primary-foreground/80 text-lg mb-6">
        Stop wasting time in Word or Excel. Generate professional electrical estimates in 60 seconds.
      </p>
