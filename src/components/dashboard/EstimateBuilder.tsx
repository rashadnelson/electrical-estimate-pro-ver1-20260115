          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-white flex items-center gap-2">
                <Calculator className="h-5 w-5 text-[#EAB308]" />
                Estimate Builder
              </CardTitle>
          ...
          <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-white/10">
            ...
            {isPaidUser ? (
              ...
              >
                <Save className="h-4 w-4 mr-2" />
                Save Template
                <span className="ml-2 text-xs bg-[#EAB308] text-white px-1.5 py-0.5 rounded">
                  PRO
                </span>
              </Button>
            )}
        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-9 bg-[#1A1A1A] border-white/20 text-white placeholder:text-white/40 focus:border-[#EAB308] focus:ring-[#EAB308] ${errors.equipmentCost ? "border-red-500" : ""}`}
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-9 bg-[#1A1A1A] border-white/20 text-white placeholder:text-white/40 focus:border-[#EAB308] focus:ring-[#EAB308] ${errors.materialsCost ? "border-red-500" : ""}`}
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`bg-[#1A1A1A] border-white/20 text-white placeholder:text-white/40 focus:border-[#EAB308] focus:ring-[#EAB308] ${errors.laborHours ? "border-red-500" : ""}`}
            />
            {errors.laborHours && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-9 bg-[#1A1A1A] border-white/20 text-white placeholder:text-white/40 focus:border-[#EAB308] focus:ring-[#EAB308] ${errors.laborRate ? "border-red-500" : ""}`}
              />
            </div>
            {errors.laborRate && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`pr-9 bg-[#1A1A1A] border-white/20 text-white placeholder:text-white/40 focus:border-[#EAB308] focus:ring-[#EAB308] ${errors.discountPercent ? "border-red-500" : ""}`}
              />
              ...
              <div className="mt-2 h-1.5 bg-white/10 rounded-full overflow-hidden">
                <div 
                  className={`h-full rounded-full transition-all ${
                    estimatesUsed >= estimatesLimit ? "bg-red-500" : "bg-[#EAB308]"
                  }`}
        ...
        <CardContent className="space-y-4">
          ...
          <div className={`space-y-3 p-4 rounded-lg bg-[#1A1A1A] border border-white/10 transition-all duration-200 ${
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className={`text-white transition-all duration-200 ${
                isCalculating && parseValue(inputs.materialsCost) > 0 ? "text-[#EAB308]" : ""
              }`}>
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className={`text-white transition-all duration-200 ${
                isCalculating && results.laborTotal > 0 ? "text-[#EAB308]" : ""
              }`}>
          ...
          {/* Final Price */}
          <div className={`p-4 rounded-lg bg-gradient-to-r from-[#EAB308]/20 to-[#EAB308]/10 border border-[#EAB308]/30 transition-all duration-200 ${
            isCalculating ? "ring-2 ring-[#EAB308]/50 scale-[1.01]" : ""
          }`}>
            <div className="flex justify-between items-center">
              <span className="text-white font-medium">Final Price</span>
              <span className={`text-3xl font-bold text-[#EAB308] transition-all duration-200 ${
          ...
          <div className="pt-4 space-y-3">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#EAB308] to-[#A01828] hover:from-[#A01828] hover:to-[#8B1523] text-white font-medium transition-all duration-200 min-h-[44px]"
            >
