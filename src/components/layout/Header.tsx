  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#1A1A1A]/95 backdrop-blur supports-[backdrop-filter]:bg-[#1A1A1A]/80">
      <div className="container flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group" aria-label="ElectroPro Estimate Home">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#EAB308] text-white transition-transform group-hover:scale-105" aria-hidden="true">
            <Zap className="h-5 w-5" />
          </div>
          <span className="font-display text-xl font-extrabold tracking-tight text-white">
            ElectroPro<span className="text-[#EAB308]">Estimate</span>
          </span>
        </Link>
