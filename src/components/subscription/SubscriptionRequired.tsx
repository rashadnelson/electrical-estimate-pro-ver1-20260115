          ...
          <Card className="w-full max-w-md bg-[#242424] border-white/10">
            <CardHeader className="text-center">
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#EAB308]/20">
                <CreditCard className="h-6 w-6 text-[#EAB308]" />
              </div>
            ...
            <CardContent className="flex flex-col gap-4">
              <Button 
                ...
                className="w-full gap-2 bg-[#EAB308] hover:bg-[#EAB308] text-white"
              >
              ...
              {content.showVerify && (
                <div className="space-y-3 pt-2 border-t border-white/10">
                  ...
                  <Button 
                    ...
                    className="w-full gap-2 border-[#EAB308]/50 text-[#EAB308] hover:bg-[#EAB308]/10 hover:text-[#EAB308]"
                  >
                    {isVerifying ? (
