...
const faqs = [
  ...
  },
  {
    ...
    answer: "Free tier PDFs include a small 'Created with ElectroPro Estimate' watermark in the footer. Paid plans generate professional, clean PDFs without any branding—perfect for client presentations.",
  },
  {
  ...
  },
  {
    ...
    answer: "We want you to be satisfied with ElectroPro Estimate. If you're not happy with your subscription, contact our support team within the first 14 days for a full refund.",
  },
  {
...
const Pricing = () => {
  ...
  return (
    <>
      <SEO 
        title="Pricing - ElectroPro Estimate"
        description="Simple, transparent pricing for professional electrical estimates. Start free, upgrade when you need more."
        canonical="https://electricalestimatepro.dev/pricing"
      />
            ...
            <div className="container relative">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <h1 className="font-display text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl text-white">
                  ...
                  <span className="block text-[#EAB308]">fits your business</span>
                </h1>
                ...
                {tiers.map((tier) => (
                  <div
                    ...
                    className={`relative rounded-2xl p-8 flex flex-col transition-all duration-300 ${
                      tier.highlighted
                        ? "border-2 border-[#EAB308] bg-[#242424] shadow-[0_0_40px_-10px_rgba(234,179,8,0.3)]"
                  ...
                  >
                    ...
                    {tier.badge && (
                      <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                        <span className="inline-flex items-center gap-1 rounded-full bg-[#EAB308] px-4 py-1.5 text-sm font-bold text-white shadow-lg">
                          {tier.badge}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="text-center pt-2">
                      ...
                      {tier.monthlyEquivalent && (
                        <p className="mt-1 text-sm text-[#EAB308] font-medium">
                          {tier.monthlyEquivalent}
                        </p>
                      )}
                    ...
                    <ul className="space-y-3 mb-8 flex-grow">
                      {tier.features.map((feature) => (
                        <li key={feature.name} className="flex items-center gap-3">
                          {feature.included ? (
                            <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#EAB308]/20 text-[#EAB308] flex-shrink-0">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-white/10 bg-[#1A1A1A]">
                        ...
                        <th className="px-6 py-4 text-center text-sm font-semibold text-[#EAB308]">Annual</th>
                      </tr>
                    </thead>
                    <tbody>
                  ...
                  {comparisonFeatures.map((feature) => (
                    <div key={feature.name} className="rounded-lg border border-white/10 bg-[#1A1A1A] p-4">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-sm">
                        ...
                        <div className="text-center">
                          <div className="text-[#EAB308] text-xs mb-1">Annual</div>
            ...
            <div className="container">
              <div className="mx-auto max-w-3xl">
                <div className="text-center mb-12">
                  <div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-4 py-2 text-sm text-white/60 mb-6">
                    <HelpCircle className="h-4 w-4 text-[#EAB308]" />
                    Common questions
                  </div>
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  {faqs.map((faq, index) => (
                    <AccordionItem 
                      key={index} 
                      value={`item-${index}`}
                      className="border border-white/10 rounded-lg px-6 bg-[#242424] data-[state=open]:border-[#EAB308]/30"
                    >
                      <AccordionTrigger className="text-left text-white hover:text-[#EAB308] hover:no-underline py-4">
                        {faq.question}
                      </AccordionTrigger>
            ...
            <div className="container">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-white/70">
                  Join hundreds of electrical professionals who create estimates in under 60 seconds.
                </p>
