            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  By accessing or using ElectroPro Estimate, you agree to be bound by these Terms of Service. 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  ElectroPro Estimate provides a web-based platform for creating, managing, and sending 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Access to ElectroPro Estimate requires a paid subscription:
                </p>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  All content, features, and functionality of ElectroPro Estimate are owned by us and are 
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground">
                  ElectroPro Estimate is provided "as is" without warranties of any kind. We are not liable 
